...
public class TestForm extends JFrame {
	...
	public TestForm() {
		...
		lstSongs.setModel(new AbstractListModel() {
			String[] values = new String[] {"Amazing Grace", "Fairest Lord Jesus", "O Church Arise", "Power of the Cross", "It is Well with My Soul", "My Jesus I Love Thee", "Sing, Sing, Sing", "In Christ Alone", "Angels We Have Heard On High"};
			public int getSize() {
